...
namespace Cirnix.Worker
{
    public static class InitFunction
    {
        ...
        internal static void InitCommand()
        {
            ...
            commandList.Register("olc", "olc", LoadCode3);
            commandList.Register("dr","閱讀", SetGameDelay);
            commandList.Register("ss", "ss", SetStartSpeed);
