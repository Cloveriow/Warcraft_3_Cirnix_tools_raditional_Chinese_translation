    ...
    public static class Hotkey
    {
        ...
        public static string GetHotkeyString(Keys key)
        {
            switch(key)
            {
                ...
                case Keys.Divide:          return "小鍵盤/";
                case Keys.Multiply:        return "小鍵盤*";
                case Keys.Subtract:        return "小鍵盤-";
                case Keys.Add:             return "小鍵盤+";
                case Keys.NumPad1:         return "小鍵盤1";
                case Keys.NumPad2:         return "小鍵盤2";
                case Keys.NumPad3:         return "小鍵盤3";
                case Keys.NumPad4:         return "小鍵盤4";
                case Keys.NumPad5:         return "小鍵盤5";
                case Keys.NumPad6:         return "小鍵盤6";
                case Keys.NumPad7:         return "小鍵盤7";
                case Keys.NumPad8:         return "小鍵盤8";
                case Keys.NumPad9:         return "小鍵盤9";
                case Keys.NumPad0:         return "小鍵盤0";
                case Keys.Decimal:         return "小鍵盤.";
